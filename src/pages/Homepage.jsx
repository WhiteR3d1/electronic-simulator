      ...
      <section className="hp-hero">
        <div className="hp-hero-content">
          ...
          <p className="hp-hero-desc">
            ออกแบบวงจรไฟฟ้าเบื้องต้น ลาก component วางบน canvas
            ต่อสาย แล้ว simulate ดูได้เลย — ฟรี ไม่ต้องติดตั้ง
          </p>
...
// ── Features data ──
const FEATURES = [
  { icon: '🖱️', title: 'Drag & Drop',    desc: 'ลาก component จาก sidebar มาวางบน canvas ได้เลย' },
  { icon: '🔌', title: 'Wire Connect',   desc: 'คลิก pin ต่อสายระหว่าง component ได้ง่ายๆ' },
  { icon: '▶️', title: 'Simulate',       desc: 'กด Run แล้วดู voltage, current, และ LED สว่างได้เลย' },
  { icon: '☁️', title: 'Cloud Save',     desc: 'บันทึก circuit ไว้บน Firebase เปิดได้ทุกที่' },
]
